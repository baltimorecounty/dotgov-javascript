...
!(function(t) {
  ...
  function h(t, i) {
    ...
    i.shiftKey && 0 === n
      ...
      : i.shiftKey || n !== e.length - 1 || (e[0].focus(), i.preventDefault());
  }
  function a(t) {
  ...
  (i.prototype.create = function(t) {
    return (
      (this._targets = this._targets || o(t) || a(this.container)),
      ...
      (this._closers = n("[data-a11y-dialog-hide]", this.container).concat(
        n('[data-a11y-dialog-hide="' + this.container.id + '"]')
      )),
    ...
    (i.prototype._bindKeypress = function(t) {
      this.shown &&
        ...
        this.shown && 9 === t.which && h(this.dialog, t);
    }),
