...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/page-specific/BaltCoGo/FollowUp.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./node_modules/@baltimorecounty/javascript-utilities/config/index.js":
/*!****************************************************************************!*\
  !*** ./node_modules/@baltimorecounty/javascript-utilities/config/index.js ***!
  \****************************************************************************/
/*! exports provided: getValue, setConfig, config */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"getValue\", function() { return getValue; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"setConfig\", function() { return setConfig; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"config\", function() { return cachedConfig; });\nvar cachedConfig = {};\nvar urlPartsRegex = /(?:http[s]*\\:\\/\\/)*(.*?)\\.(?=[^\\/]*\\..{2,5})/i;\n\nvar getSubDomain = function getSubDomain(url) {\n  var urlParts = urlPartsRegex.exec(url);\n  return urlParts && urlParts.length > 1 ? urlParts[1].toLowerCase() : null;\n};\n\nvar getEnvironment = function getEnvironment() {\n  var hostname = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';\n  var subDomain = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';\n\n  if (hostname.indexOf('localhost') > -1) {\n    return 'local';\n  } else if (subDomain === 'staging') {\n    return subDomain;\n  } else if (subDomain === 'dev') {\n    return 'development';\n  } else if (!subDomain || subDomain === 'www') {\n    return 'production';\n  }\n\n  return 'local';\n};\n\nvar hasConfig = function hasConfig() {\n  return Object.keys(cachedConfig).length > 0;\n};\n\nvar getValue = function getValue(key) {\n  if (!hasConfig()) {\n    console.error(\"It doesn't look like a config has been specified, be sure to call 'setConfig' with your config values.\");\n    return;\n  }\n\n  var _window$location = window.location,\n      _window$location$href = _window$location.href,\n      href = _window$location$href === void 0 ? '' : _window$location$href,\n      _window$location$host = _window$location.hostname,\n      hostname = _window$location$host === void 0 ? '' : _window$location$host;\n  var subDomain = getSubDomain(href);\n  var environmentKey = getEnvironment(hostname, subDomain);\n  var environmentConfig = cachedConfig.hasOwnProperty(environmentKey) ? cachedConfig[environmentKey] : null;\n\n  if (!environmentConfig) {\n    console.error(\"Unable to retrieve value. The \\\"\".concat(environmentKey, \"\\\" config does not exist.\"));\n    return;\n  }\n\n  var environmentValue = environmentConfig[key];\n  return environmentValue ? environmentValue : console.error(\"Unable to retrieve value. The \".concat(environmentKey, \" config does not contain the key \\\"\").concat(key, \"\\\".\"));\n};\n\nvar setConfig = function setConfig(config) {\n  cachedConfig = config;\n};\n\n\n\n//# sourceURL=webpack://Bc%5Bname%5D/./node_modules/@baltimorecounty/javascript-utilities/config/index.js?");
...
eval("module.exports = __webpack_require__(/*! ./lib/axios */ \"./node_modules/axios/lib/axios.js\");\n\n//# sourceURL=webpack://Bc%5Bname%5D/./node_modules/axios/index.js?");
...
"use strict";
eval("\n/**\n * A `Cancel` is an object that is thrown when an operation is canceled.\n *\n * @class\n * @param {string=} message The message.\n */\n\nfunction Cancel(message) {\n  this.message = message;\n}\n\nCancel.prototype.toString = function toString() {\n  return 'Cancel' + (this.message ? ': ' + this.message : '');\n};\n\nCancel.prototype.__CANCEL__ = true;\nmodule.exports = Cancel;\n\n//# sourceURL=webpack://Bc%5Bname%5D/./node_modules/axios/lib/cancel/Cancel.js?");
...
"use strict";
eval("\n\nmodule.exports = function isCancel(value) {\n  return !!(value && value.__CANCEL__);\n};\n\n//# sourceURL=webpack://Bc%5Bname%5D/./node_modules/axios/lib/cancel/isCancel.js?");
...
"use strict";
eval("\n\nvar utils = __webpack_require__(/*! ./../utils */ \"./node_modules/axios/lib/utils.js\");\n/**\n * Transform the data for a request or a response\n *\n * @param {Object|String} data The data to be transformed\n * @param {Array} headers The headers for the request or response\n * @param {Array|Function} fns A single function or Array of functions\n * @returns {*} The resulting transformed data\n */\n\n\nmodule.exports = function transformData(data, headers, fns) {\n  /*eslint no-param-reassign:0*/\n  utils.forEach(fns, function transform(fn) {\n    data = fn(data, headers);\n  });\n  return data;\n};\n\n//# sourceURL=webpack://Bc%5Bname%5D/./node_modules/axios/lib/core/transformData.js?");
...
"use strict";
eval("\n\nmodule.exports = function bind(fn, thisArg) {\n  return function wrap() {\n    var args = new Array(arguments.length);\n\n    for (var i = 0; i < args.length; i++) {\n      args[i] = arguments[i];\n    }\n\n    return fn.apply(thisArg, args);\n  };\n};\n\n//# sourceURL=webpack://Bc%5Bname%5D/./node_modules/axios/lib/helpers/bind.js?");
...
"use strict";
eval("\n/**\n * Creates a new URL by combining the specified URLs\n *\n * @param {string} baseURL The base URL\n * @param {string} relativeURL The relative URL\n * @returns {string} The combined URL\n */\n\nmodule.exports = function combineURLs(baseURL, relativeURL) {\n  return relativeURL ? baseURL.replace(/\\/+$/, '') + '/' + relativeURL.replace(/^\\/+/, '') : baseURL;\n};\n\n//# sourceURL=webpack://Bc%5Bname%5D/./node_modules/axios/lib/helpers/combineURLs.js?");
...
"use strict";
eval("\n\nvar utils = __webpack_require__(/*! ../utils */ \"./node_modules/axios/lib/utils.js\");\n\nmodule.exports = function normalizeHeaderName(headers, normalizedName) {\n  utils.forEach(headers, function processHeader(value, name) {\n    if (name !== normalizedName && name.toUpperCase() === normalizedName.toUpperCase()) {\n      headers[normalizedName] = value;\n      delete headers[name];\n    }\n  });\n};\n\n//# sourceURL=webpack://Bc%5Bname%5D/./node_modules/axios/lib/helpers/normalizeHeaderName.js?");
...
"use strict";
eval("\n/**\n * Syntactic sugar for invoking a function and expanding an array for arguments.\n *\n * Common use case would be to use `Function.prototype.apply`.\n *\n *  ```js\n *  function f(x, y, z) {}\n *  var args = [1, 2, 3];\n *  f.apply(null, args);\n *  ```\n *\n * With `spread` this example can be re-written.\n *\n *  ```js\n *  spread(function(x, y, z) {})([1, 2, 3]);\n *  ```\n *\n * @param {Function} callback\n * @returns {Function}\n */\n\nmodule.exports = function spread(callback) {\n  return function wrap(arr) {\n    return callback.apply(null, arr);\n  };\n};\n\n//# sourceURL=webpack://Bc%5Bname%5D/./node_modules/axios/lib/helpers/spread.js?");
...
eval("/*!\n * Determine if an object is a Buffer\n *\n * @author   Feross Aboukhadijeh <https://feross.org>\n * @license  MIT\n */\nmodule.exports = function isBuffer(obj) {\n  return obj != null && obj.constructor != null && typeof obj.constructor.isBuffer === 'function' && obj.constructor.isBuffer(obj);\n};\n\n//# sourceURL=webpack://Bc%5Bname%5D/./node_modules/axios/node_modules/is-buffer/index.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return formatRelative; });\nvar formatRelativeLocale = {\n  lastWeek: \"'last' eeee 'at' p\",\n  yesterday: \"'yesterday at' p\",\n  today: \"'today at' p\",\n  tomorrow: \"'tomorrow at' p\",\n  nextWeek: \"eeee 'at' p\",\n  other: 'P'\n};\nfunction formatRelative(token, _date, _baseDate, _options) {\n  return formatRelativeLocale[token];\n}\n\n//# sourceURL=webpack://Bc%5Bname%5D/./node_modules/date-fns/esm/locale/en-US/_lib/formatRelative/index.js?");
...
eval("module.exports = function (module) {\n  if (!module.webpackPolyfill) {\n    module.deprecate = function () {};\n\n    module.paths = []; // module.parent = undefined by default\n\n    if (!module.children) module.children = [];\n    Object.defineProperty(module, \"loaded\", {\n      enumerable: true,\n      get: function get() {\n        return module.l;\n      }\n    });\n    Object.defineProperty(module, \"id\", {\n      enumerable: true,\n      get: function get() {\n        return module.i;\n      }\n    });\n    module.webpackPolyfill = 1;\n  }\n\n  return module;\n};\n\n//# sourceURL=webpack://Bc%5Bname%5D/(webpack)/buildin/module.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _lib_axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../lib/axios */ \"./src/lib/axios.js\");\n/* harmony import */ var _baltimorecounty_javascript_utilities_config__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @baltimorecounty/javascript-utilities/config */ \"./node_modules/@baltimorecounty/javascript-utilities/config/index.js\");\n/* harmony import */ var _templates_BaltCoGo_Templates__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../templates/BaltCoGo-Templates */ \"./src/templates/BaltCoGo-Templates.js\");\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\n\n\n\n/**\r\n * Setup the api endpoints for the different environments\r\n */\n\nvar initialEndpoint = \"platform.citysourced.net/servicerequests\";\nvar testApiRoot = \"https://testservices.baltimorecountymd.gov/\".concat(initialEndpoint);\nvar prodApiRoot = \"https://services.baltimorecountymd.gov/\".concat(initialEndpoint); // HACK - the Config utiltiy does not account for beta.\n// TODO: This will need to be addressed when we get closer to launch\n\nvar localApiRoot = window.location.hostname.indexOf(\"beta\") > -1 ? testApiRoot : \"//localhost:54727/\".concat(initialEndpoint);\nvar configValues = {\n  local: {\n    apiRoot: localApiRoot\n  },\n  development: {\n    apiRoot: testApiRoot\n  },\n  staging: {\n    apiRoot: testApiRoot\n  },\n  production: {\n    apiRoot: prodApiRoot\n  }\n};\nObject(_baltimorecounty_javascript_utilities_config__WEBPACK_IMPORTED_MODULE_1__[\"setConfig\"])(configValues);\nvar appDocumentIds = {\n  form: \"service-request-form\",\n  loadingIndicator: \"sr-loading-indicator\",\n  reportDetails: \"report-details\",\n  resetForm: \"sr-reset-form\",\n  submit: \"get-report\"\n};\n/**\r\n * Clear the results container\r\n */\n\nvar clearResults = function clearResults() {\n  displayResults(\"\");\n};\n/**\r\n * Displays any Result Success or Failure\r\n * @param {*} html\r\n */\n\n\nvar displayResults = function displayResults(html) {\n  var resultsElm = document.getElementById(appDocumentIds.reportDetails);\n  resultsElm.innerHTML = \"\";\n\n  if (html) {\n    resultsElm.appendChild(html);\n  }\n};\n/**\r\n * Displays a service request based on the report details template\r\n * @param {object} serviceRequest\r\n */\n\n\nvar displayServiceRequest = function displayServiceRequest(serviceRequest) {\n  var _serviceRequest$repor = serviceRequest.report,\n      report = _serviceRequest$repor === void 0 ? {} : _serviceRequest$repor,\n      _serviceRequest$comme = serviceRequest.comments,\n      comments = _serviceRequest$comme === void 0 ? [] : _serviceRequest$comme;\n\n  if (report.ErrorsCount === 0) {\n    var reportDetails = Object(_templates_BaltCoGo_Templates__WEBPACK_IMPORTED_MODULE_2__[\"reportDetailsTemplateFn\"])(report.Results, comments.Results);\n    displayResults(reportDetails);\n  } else {\n    displayDefaultError();\n  }\n\n  return serviceRequest;\n};\n/**\r\n * Displays a default error for the application\r\n */\n\n\nvar displayDefaultError = function displayDefaultError() {\n  displayResults(Object(_templates_BaltCoGo_Templates__WEBPACK_IMPORTED_MODULE_2__[\"defaultErrorTemplateFn\"])());\n};\n/**\r\n * Displays a server error\r\n */\n\n\nvar displayServerError = function displayServerError() {\n  displayResults(Object(_templates_BaltCoGo_Templates__WEBPACK_IMPORTED_MODULE_2__[\"defaultServerErrorTemplateFn\"])());\n};\n/**\r\n * Display an error showing the report tracking info is stored in another system\r\n * @param {*} url\r\n */\n\n\nvar displayWrongTrackingSystem = function displayWrongTrackingSystem(url) {\n  var errorHtml = Object(_templates_BaltCoGo_Templates__WEBPACK_IMPORTED_MODULE_2__[\"errorTemplateFn\"])({\n    url: url\n  });\n  displayResults(errorHtml);\n};\n/** Shortcut function for document */\n\n\nvar getElmById = function getElmById(id) {\n  return document.getElementById(id);\n};\n/** Toggle the visibility of an element  */\n\n\nvar toggleElm = function toggleElm(elm) {\n  var status = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : \"show\";\n\n  if (status.toLowerCase() === \"show\") {\n    elm.classList.remove(\"hidden\");\n  } else {\n    elm.classList.add(\"hidden\");\n  }\n};\n/**\r\n * Toggle a list of elements visibility\r\n * @param {*} elms\r\n * @param {*} status\r\n */\n\n\nvar toggleElms = function toggleElms() {\n  var elms = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];\n  var status = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : \"show\";\n  elms.forEach(function (elm) {\n    toggleElm(elm, status);\n  });\n};\n/**\r\n * List of actions for a service request based on the format of the service request number\r\n */\n\n\nvar reportTypes = [{\n  name: \"AnimalServiceRequest\",\n  testRegex: RegExp(/^(ACCMP)/i),\n  action: function action() {\n    displayWrongTrackingSystem(\"https://citizenaccess.baltimorecountymd.gov/CitizenAccess/Cap/CapHome.aspx?&Module=Enforce\");\n  }\n}, {\n  name: \"VendorServiceRequest\",\n  testRegex: RegExp(/^(CC|CRH|CS|PP|TS|CE|CP|CB|CG)\\d+$/i),\n  action: function action() {\n    displayWrongTrackingSystem(\"https://citizenaccess.baltimorecountymd.gov/CitizenAccess/Cap/CapHome.aspx?&Module=Enforcement\");\n  }\n}, {\n  name: \"StandardServiceRequest\",\n  testRegex: RegExp(/^\\d+$/i),\n  action: function action(trackingNumber) {\n    return _lib_axios__WEBPACK_IMPORTED_MODULE_0__[\"default\"].get(\"\".concat(Object(_baltimorecounty_javascript_utilities_config__WEBPACK_IMPORTED_MODULE_1__[\"getValue\"])(\"apiRoot\"), \"/\").concat(trackingNumber)).then(function (response) {\n      return response.data;\n    }).then(displayServiceRequest)[\"catch\"](displayServerError);\n  }\n}, {\n  name: \"default\",\n  action: displayDefaultError\n}];\n/**\r\n * Get follow up information based on a given service request number\r\n * @param {*} submitEvent\r\n */\n\nvar GetReport =\n/*#__PURE__*/\nfunction () {\n  var _ref = _asyncToGenerator(\n  /*#__PURE__*/\n  regeneratorRuntime.mark(function _callee(submitEvent) {\n    var trackingNumber, i, len, reportType;\n    return regeneratorRuntime.wrap(function _callee$(_context) {\n      while (1) {\n        switch (_context.prev = _context.next) {\n          case 0:\n            submitEvent.preventDefault();\n            trackingNumber = document.getElementById(\"TrackingNumber\").value.trim();\n            i = 0, len = reportTypes.length;\n\n          case 3:\n            if (!(i < len)) {\n              _context.next = 23;\n              break;\n            }\n\n            reportType = reportTypes[i];\n\n            if (!(reportType.name === \"default\" || reportType.testRegex.test(trackingNumber))) {\n              _context.next = 20;\n              break;\n            }\n\n            toggleElms([getElmById(appDocumentIds.form)], \"hide\");\n            toggleElms([getElmById(appDocumentIds.loadingIndicator)], \"show\");\n            _context.prev = 8;\n            _context.next = 11;\n            return reportType.action(trackingNumber);\n\n          case 11:\n            _context.next = 15;\n            break;\n\n          case 13:\n            _context.prev = 13;\n            _context.t0 = _context[\"catch\"](8);\n\n          case 15:\n            _context.prev = 15;\n            toggleElms([getElmById(appDocumentIds.loadingIndicator)], \"hide\");\n            toggleElms([getElmById(appDocumentIds.resetForm)], \"show\");\n            return _context.finish(15);\n\n          case 19:\n            return _context.abrupt(\"break\", 23);\n\n          case 20:\n            i++;\n            _context.next = 3;\n            break;\n\n          case 23:\n          case \"end\":\n            return _context.stop();\n        }\n      }\n    }, _callee, null, [[8, 13, 15, 19]]);\n  }));\n\n  return function GetReport(_x) {\n    return _ref.apply(this, arguments);\n  };\n}();\n/** Reset the follow up form to it's initial state */\n\n\nvar ResetForm = function ResetForm() {\n  clearResults();\n  var formElm = getElmById(appDocumentIds.form);\n  toggleElms([formElm], \"show\");\n  toggleElms([getElmById(appDocumentIds.resetForm)], \"hide\");\n  getElmById(\"mainContent\").scrollIntoView();\n};\n/** Events */\n\n\ndocument.getElementById(appDocumentIds.form).addEventListener(\"submit\", GetReport);\ndocument.getElementById(appDocumentIds.resetForm).addEventListener(\"click\", ResetForm);\n\n//# sourceURL=webpack://Bc%5Bname%5D/./src/page-specific/BaltCoGo/FollowUp.js?");

/***/ }),

/***/ "./src/templates/BaltCoGo-Templates.js":
/*!*********************************************!*\
  !*** ./src/templates/BaltCoGo-Templates.js ***!
  \*********************************************/
/*! exports provided: defaultErrorTemplateFn, defaultServerErrorTemplateFn, commentsTemplateFn, errorTemplateFn, reportDetailsTemplateFn */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"defaultErrorTemplateFn\", function() { return defaultErrorTemplateFn; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"defaultServerErrorTemplateFn\", function() { return defaultServerErrorTemplateFn; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"commentsTemplateFn\", function() { return commentsTemplateFn; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"errorTemplateFn\", function() { return errorTemplateFn; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"reportDetailsTemplateFn\", function() { return reportDetailsTemplateFn; });\n/* harmony import */ var _TemplateHelpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./TemplateHelpers */ \"./src/templates/TemplateHelpers.js\");\n/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! date-fns */ \"./node_modules/date-fns/esm/index.js\");\nfunction _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _nonIterableSpread(); }\n\nfunction _nonIterableSpread() { throw new TypeError(\"Invalid attempt to spread non-iterable instance\"); }\n\nfunction _iterableToArray(iter) { if (Symbol.iterator in Object(iter) || Object.prototype.toString.call(iter) === \"[object Arguments]\") return Array.from(iter); }\n\nfunction _arrayWithoutHoles(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = new Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } }\n\n\n\nvar dateFormat = \"MM/dd/yyyy hh:mm a\";\n\nvar formatDate = function formatDate(dateString) {\n  return Object(date_fns__WEBPACK_IMPORTED_MODULE_1__[\"format\"])(Object(date_fns__WEBPACK_IMPORTED_MODULE_1__[\"parseISO\"])(dateString), dateFormat);\n};\n\nvar commentsTemplateFn = function commentsTemplateFn(comments) {\n  return \"<h4>Comments</h4>\\n    <ul id=\\\"comments\\\">\".concat(comments.map(function (comment) {\n    return \"<div class=\\\"dg_card text-left\\\">\\n          \".concat(comment.Text, \"\\n          <div class=\\\"dg_card__content\\\">\\n            <span class=\\\"author-name\\\">\").concat(comment.AuthorName, \"</span>\\n            <span class=\\\"author-date\\\">\").concat(comment.DateCreatedFormatted, \"</span>\\n          </div>\\n        </div>\");\n  }).join(\"\"), \"\\n    </ul>\");\n};\n\nvar reportDetailsTemplateFn = function reportDetailsTemplateFn(report, comments) {\n  var sortedComments = _toConsumableArray(comments).reverse();\n\n  return Object(_TemplateHelpers__WEBPACK_IMPORTED_MODULE_0__[\"compileTemplate\"])(\"<div class=\\\"table-responsive\\\">\\n      <h2>Track Status</h2>\\n      <h3>\\n        Report Status: <span>\".concat(report.StatusTypeReadable, \"</span>\\n      </h3>\\n      <table class=\\\"table\\\">\\n        <tbody>\\n          <tr>\\n            <th>Request ID</th>\\n            <td>\").concat(report.Id, \"</td>\\n          </tr>\\n          <tr>\\n            <th>Issue Type</th>\\n            <td>\").concat(report.RequestType, \"</td>\\n          </tr>\\n          <tr>\\n            <th>Date Created</th>\\n            <td>\").concat(formatDate(report.DateCreated), \"</td>\\n          </tr>\\n          <tr>\\n            <th>Last Updated</th>\\n            <td>\").concat(formatDate(report.DateUpdated), \"</td>\\n          </tr>\\n          <tr>\\n            <th>Location</th>\\n            <td id=\\\"location\\\">\").concat(report.FormattedAddress, \"</td>\\n          </tr>\\n        </tbody>\\n      </table>\\n      \").concat(comments && comments.length > 0 ? commentsTemplateFn(sortedComments) : \"\", \"\\n    </div>\"));\n};\n\nvar error = function error(text) {\n  return Object(_TemplateHelpers__WEBPACK_IMPORTED_MODULE_0__[\"compileTemplate\"])(\"<div role=\\\"alert\\\" class=\\\"alert-information bc_alert\\\">\\n        <i class=\\\"fa fa-icon fa-2x fa-info-circle\\\"></i>\\n        <p>\".concat(text, \"</p>\\n    </div>\"));\n};\n\nvar defaultErrorTemplateFn = function defaultErrorTemplateFn() {\n  return error(\"We couldn’t find any records that match the ID number you entered. Please double check the number and try again.\");\n};\n\nvar defaultServerErrorTemplateFn = function defaultServerErrorTemplateFn() {\n  return error(\"We’re having trouble connecting to our servers right now. Please try again in a few minutes.\");\n};\n\nvar errorTemplateFn = function errorTemplateFn(error) {\n  return Object(_TemplateHelpers__WEBPACK_IMPORTED_MODULE_0__[\"compileTemplate\"])(\"<div class=\\\"alert-information\\\" id=\\\"citizen-access-info\\\">\\n        <p>The record you\\u2019re looking for is available in a different tracking system. Please visit <a id=\\\"RedirectURLParameter\\\" href=\\\"\".concat(error.url, \"\\\">Baltimore County Online Services</a> and enter the tracking number again.</p>\\n        <p>We\\u2019re working to better integrate these systems in the future. Until then, we apologize for any inconvenience this may cause.</p>\\n    </div>\"));\n};\n\n\n\n//# sourceURL=webpack://Bc%5Bname%5D/./src/templates/BaltCoGo-Templates.js?");

/***/ }),

/***/ "./src/templates/TemplateHelpers.js":
/*!******************************************!*\
  !*** ./src/templates/TemplateHelpers.js ***!
  \******************************************/
/*! exports provided: compileTemplate */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"compileTemplate\", function() { return compileTemplate; });\n/**\r\n * @param {String} HTML\r\n * @return {Element}\r\n */\nvar compileTemplate = function compileTemplate(html) {\n  // https://stackoverflow.com/a/494348/1143670\n  var div = document.createElement(\"div\");\n  div.innerHTML = html.trim(); // Change this to div.childNodes to support multiple top-level nodes\n\n  return div.firstChild;\n};\n\n\n\n//# sourceURL=webpack://Bc%5Bname%5D/./src/templates/TemplateHelpers.js?");
