...
//We are doing this crazy way of loading strictly because IE will not load the inclusions in the correct order. This gives it a chance to loadthe files before executing the datatable create function
