...
var link = {
  ...
  start_report:
    "http://www.baltimorecountymd.gov/Redirect/externalwebsites/Coplogic/no-report-type.html",
  theft: {
    motor:
      "http://www.baltimorecountymd.gov/Redirect/externalwebsites/Coplogic/theftfromvehicleredirect.html",
    nomotor:
      "http://www.baltimorecountymd.gov/Redirect/externalwebsites/Coplogic/theftredirect.html",
    sepage:
      "http://www.baltimorecountymd.gov/Agencies/police/onlinereport/theft.html",
  },
  abandoned:
    "http://www.baltimorecountymd.gov/Redirect/externalwebsites/Coplogic/abandonedvehicleredirect.html",
  lost_property:
    "http://www.baltimorecountymd.gov/Redirect/externalwebsites/Coplogic/lostpropertyredirect.html",
  des_of_property: {
    motor:
      "http://www.baltimorecountymd.gov/Redirect/externalwebsites/Coplogic/destructionpropertyvehicleredirect.html",
    nomotor:
      "http://www.baltimorecountymd.gov/Redirect/externalwebsites/Coplogic/destructionpropertyredirect.html",
  },
  hit_and_run:
    "http://www.baltimorecountymd.gov/Redirect/externalwebsites/Coplogic/hitandrunredirect.html",
  shop_lifting:
    "http://www.baltimorecountymd.gov/Redirect/externalwebsites/Coplogic/startreport.html", //Need to replace with Prod//Need to replace with Prod
};
...
var definition = {
  ...
  serial:
    "Any property that has a unique identifier from the manufacturer, such as a serial number or registration number. <strong>Some Examples Are:</strong> Televisions, bicycles, computers, stereo equipment, etc...",
};
    ...
    if (start != -1) {
      if (start > -1 && end == -1) {
        tmpString =
          ...
          tmpString.substring(tmpString.indexOf(keyword)).indexOf(" ") + start;
        tmpString =
          tmpString.substring(0, start) +
          "<a href='#" +
          keyword +
...
$(document).ready(function () {
  ...
  $.ajax({
    ...
    success: function (xml) {
      ...
      htmlString +=
        '<div class="noreport">&nbsp;</div><div class="success">&nbsp;</div>';
      ...
      $("div.questions ul li:not(:first-child), div.questions a").each(
        function () {
      ...
      $("div.questions :input").click(function () {
        ...
        if (
          $(this).parent().hasClass("shoplifting") &&
          $(this).parent().children("p").text() == "Is there a known suspect?"
        ) {
          ...
          if (answer_text == "No") {
            ...
            $("div.success")
              .html(
                "<p>Since there is no known suspect, you will need to file a theft report.</p>&nbsp;<a href='" +
                  link.theft.sepage +
                  "' class='goToForm'>File a Theft Report Now</a>"
              )
              .css("color", "green");
          }
        }
        ...
        if ($(this).hasClass("correct")) {
          ...
          if ($questionContainer.next().children().html() != null) {
            ...
            generateQtip(
              $questionContainer.next().children().html(),
              keywordArray
            );
          }
        }
        ...
        //wrong answer
          ...
          $questionContainer.siblings(":not(.answered)").hide();

          if (
            $(this).parent().html().indexOf("Baltimore County, Maryland?") > -1
          ) {
            $("div.noreport")
              .html(
                "<p>Sorry, you cannot file your report with Baltimore County. Notify the jurisidiction where the incident occured."
              )
              .css("color", "red");
          } else {
            if ($(this).hasClass("noanswer")) {
